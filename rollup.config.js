...
const config = [
  ...
  {
    input: {
      bootstrap: Path.resolve(__dirname, './src/runtime/bootstrap/index.ts'),
      functions: Path.resolve(__dirname, './src/runtime/functions/index.ts'),
      helmet: Path.resolve(__dirname, './src/runtime/helmet/index.ts'),
      lazy: Path.resolve(__dirname, './src/runtime/lazy/index.ts'),
      routing: Path.resolve(__dirname, './src/runtime/routing/index.ts'),
      server: Path.resolve(__dirname, './src/runtime/server/index.ts'),
    },
    output: {
