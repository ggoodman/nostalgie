    ...
    <ScrollPadding className={tw('container mx-auto antialiased')}>
      <div className={tw('px-4 py-6 text-gray-900')}>
        <header>
          <h1
            className={tw(
              'text-4xl sm:text-6xl lg:text-7xl leading-none font-extrabold tracking-tight text-gray-900 mt-10 mb-8 sm:mt-14 sm:mb-10'
            )}
          >
          ...
          <p
            className={tw(
              'text-gray-500 max-w-screen-lg text-lg sm:text-2xl sm:leading-10 font-medium mb-10'
            )}
          >
        ...
        <div id="opinionated" className={tw('mb-20 md:mb-32 w-full lg:w-3/5')}>
          ...
          <p
            className={tw(
              'text-3xl sm:text-5xl lg:text-6xl leading-none font-extrabold text-gray-900 tracking-tight mb-8'
            )}
          >
          ...
          <p
            className={tw(
              'text-gray-500 text-lg sm:text-2xl font-medium sm:leading-10 space-y-6 mb-6'
            )}
          >
            Nostalgie focuses on areas that are critical to every modern web. It
            makes a bet on leading technologies in each category. In having
            these opinions and in making these choices, Nostalgie provides a
            tightly integrated, highly-productive environment to get @#$% done.
          </p>
        </div>
        <div
          id="server-functions"
        ...
        >
          ...
          >
            ...
            deduplication. You may even realize that you don't need complex
            state management anymore.
          </p>
          <H3>Server</H3>
          <H3>Browser</H3>
        </div>
        <div id="features" className={tw('mb-20')}>
          <div className={tw('w-full lg:w-3/5 mb-8')}>
            ...
            <p
              className={tw(
                'text-gray-500 text-lg sm:text-2xl font-medium sm:leading-10 space-y-6'
              )}
            >
              There are a few things that almost every app needs but that are{' '}
              <em>hard</em> and repetitive. It's a lot of work to do these
              things well and while you're struggling with them, you're not
              building your app. Nostalgie frees you from this burden so that
          ...
          >
            <div className={tw('border rounded-lg overflow-hidden shadow')}>
              ...
              <div className={tw('p-4 leading-7')}>
                <p>
                  Your app lives on the web and the web works with URLs.
                  Nostalgie has you covered.
                </p>
                <ul>
                  <li>
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      Every bit of critical JavaScript and CSS will be
                      preloaded. Waterfalls are beautiful but we don't want them
                      in our web apps.
                    </p>
                  </li>
                </ul>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      it to authorized users. With a fallback render prop, you
                      can render an alternative for unauthorized users with an
            ...
            <div className={tw('border rounded-lg overflow-hidden shadow')}>
              ...
              <div className={tw('p-4 leading-7')}>
                <p>
                  Getting the right information to all the right crawlers in
                  React apps has never been easy. Nostalgie makes it easy.
                </p>
                <ul>
                  <li>
                    <h3 className={tw('text-lg font-semibold')}>
                    ...
                    <p>
                      ...
                      can tweak your top-level markup anywhere in the render
                      tree. Five levels deep in lazy-loaded components? No
                      problem.
                    </p>
                  </li>
                  <li>
                    ...
                    <p>
                      ...
                      SEO tags will be rendered on the server no matter where
                      you set them.
                    </p>
                  </li>
                </ul>
