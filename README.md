...
If we want to use this function from our application code, we use the `useQueryFunction` hook
...
- **Authentication**: Built-in authentication with any OpenID-compliant issuer. When configured with
